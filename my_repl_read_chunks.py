...
chunks = read_sales_csv_in_chunks("data/raw/online_retail.csv", 50000)

first_chunk = next(chunks)
print(first_chunk.head(7))
print("Displaing first 7 rows of the first chunk")
second_chunk = next(chunks)
print(second_chunk.head(7))
